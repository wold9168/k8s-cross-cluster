...
func main() {
	...
	for {
		...
		fmt.Printf("There are %d configMaps in the cluster\n", len(configMaps.Items))
		...
		if errors.IsNotFound(err) {
			fmt.Printf("ConfigMap example-xxxxx not found in default namespace\n")
			...
			fmt.Printf("Found example-xxxxx configMap in default namespace\n")
		}
