...
type MetricsCollector struct {
	// 业务指标
	configUpdateCount  prometheus.Gauge
...
func (c *MetricsCollector) initPrometheusMetrics() {
	// 业务指标
	c.configUpdateCount = prometheus.NewGauge(prometheus.GaugeOpts{
...
func (c *MetricsCollector) recordBusinessMetrics() {
	c.configUpdateCount.Set(float64(c.configUpdateCountValue))
...
func (c *MetricsCollector) getGCCycles() uint32 {
	var memStats runtime.MemStats
	runtime.ReadMemStats(&memStats)
